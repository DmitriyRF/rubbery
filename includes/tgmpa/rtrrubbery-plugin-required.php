<?php
/**
 * This file represents an plugin's theme would use to register
...
add_action( 'tgmpa_register', 'rtrrubbery_register_required_plugins' );

function rtrrubbery_register_required_plugins() {
	/*
