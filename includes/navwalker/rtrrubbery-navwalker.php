 ...
 */
/*
 * Class Name: rtrrubbery_bs4_centralLogo_menu_navwalker
...
if ( ! class_exists( 'rtrrubbery_bs4_centralLogo_menu_navwalker' ) ) {
    /**
     * rtrrubbery_bs4_centralLogo_menu_navwalker class.
     *
     * @extends Walker_Nav_Menu
     */
    class rtrrubbery_bs4_centralLogo_menu_navwalker extends Walker_Nav_Menu {
        /**
         * Start Level.
         *
        ...
        public function start_lvl( &$output, $depth = 0, $args = array() ) {
            ...
            //Switcher for chose animation for dropdown nemu, that be in CSS
            switch ($depth) {
                case 0:
                    { $animationclass = 'fade-In-Down-Rtr-Rubbery-Menu'; break;}
                    break;
                case 1:
                    { $animationclass = 'fade-In-Right-Rtr-Rubbery-Menu'; break;}
                    break;
                default:
                    { $animationclass = ''; break;}
            }

            // $output .= "\n$indent<div class=\"point-of-origin-$depth\">\n";// wraperr for overflow hidden animation
            // $output .= "\n$indent<div class=\"menu-level-position-$depth\">\n";// wraperr for overflow hidden animation
            $output .= "\n$indent<ul role=\"menu\" class=\" dropdown-menu animated ".$animationclass." level-$depth\" " . $labledby . ">\n";
        }
